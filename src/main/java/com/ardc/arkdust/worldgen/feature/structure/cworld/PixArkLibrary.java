...
import com.ardc.arkdust.CodeMigration.RunHelper.*;
...
public class PixArkLibrary extends Structure<NoFeatureConfig> implements ArdStructureAddInfo {
    ...
    protected boolean isFeatureChunk(ChunkGenerator chunkGenerator, BiomeProvider biomeSource,
        ...
        return StructureHelper.isEachPlaceAvailable(chunkGenerator, Heightmap.Type.WORLD_SURFACE_WG,6,
    ...
    public static class Start extends StructureStart<NoFeatureConfig> {
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            BlockPos centerPos = new BlockPos(x,Math.max(landHeight-4,1),z);
...
//                        ((ChestTileEntity) tileentity).setLootTable(LootTable.CW_BLUEPRINT_BOX, preRandom.nextLong() + r.nextLong());
//                    }
                }else{
