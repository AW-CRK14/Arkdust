...
public class OldHouse0Pool {
    public static JigsawPattern pool_common =
            new JigsawPattern(
                    ...
                    ImmutableList.of(Pair.of(JigsawPiece.legacy(Utils.MOD_ID + ":cworld/old_house/old_house_1_0", StructureProcessorListAdd.INTEGRITY_95), 1)),
    ...
    public static JigsawPattern pool_broken =
            new JigsawPattern(
                    ...
                    new ResourceLocation("empty"),
                    ImmutableList.of(
                            Pair.of(JigsawPiece.legacy(Utils.MOD_ID + ":cworld/old_house/old_house_1_1",StructureProcessorListAdd.SPIDER_WEB_25),1),
                            Pair.of(JigsawPiece.legacy(Utils.MOD_ID + ":cworld/old_house/old_house_1_2",StructureProcessorListAdd.SPIDER_WEB_25),1),
                            Pair.of(JigsawPiece.legacy(Utils.MOD_ID + ":cworld/old_house/old_house_1_3",StructureProcessorListAdd.SPIDER_WEB_75),1),
                            Pair.of(JigsawPiece.legacy(Utils.MOD_ID + ":cworld/old_house/old_house_1_4",StructureProcessorListAdd.SPIDER_WEB_75),1)
                    ),
                    JigsawPattern.PlacementBehaviour.RIGID
            );
