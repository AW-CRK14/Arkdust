...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> originium = ITEMS.register("originium", ()->new PreOIItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL),true,3,2,3,12,4));//源石
    public static final RegistryObject<Item> originium_dust = ITEMS.register("originium_dust", ()->new PreOIItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL),false,2,0,1,32,8));//源石尘e1
    public static final RegistryObject<Item> originium_shard = ITEMS.register("originium_shard", ()->new PreOIItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL),false,2,1,0,4,1));//源石碎片
    public static final RegistryObject<Item> poor_originium = ITEMS.register("poor_originium", ()->new PreOIItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL),false,1,0,0,0,2));//贫瘠源石
    public static final RegistryObject<Item> ester = ITEMS.register("ester", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级酯
    public static final RegistryObject<Item> polyester = ITEMS.register("polyester", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级酯
    public static final RegistryObject<Item> polyester_pack = ITEMS.register("polyester_pack", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//三级酯
    public static final RegistryObject<Item> polyester_lump = ITEMS.register("polyester_lump", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//四级酯
    public static final RegistryObject<Item> diketon = ITEMS.register("diketon", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级酮
    public static final RegistryObject<Item> polyketon = ITEMS.register("polyketon", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级酮
    public static final RegistryObject<Item> aketon = ITEMS.register("aketon", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//三级酮
    public static final RegistryObject<Item> keton_colloid = ITEMS.register("keton_colloid", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//四级酮
    public static final RegistryObject<Item> oriron_shard = ITEMS.register("oriron_shard", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级异铁
    public static final RegistryObject<Item> oriron = ITEMS.register("oriron", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级异铁
    public static final RegistryObject<Item> oriron_cluster = ITEMS.register("oriron_cluster", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//三级异铁
    public static final RegistryObject<Item> oriron_block = ITEMS.register("oriron_block", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//四级异铁
    public static final RegistryObject<Item> crystalline_component = ITEMS.register("crystalline_component", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级电子晶体
    public static final RegistryObject<Item> crystalline_circuit = ITEMS.register("crystalline_circuit", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级电子晶体
    public static final RegistryObject<Item> crystalline_electronic_unit = ITEMS.register("crystalline_electronic_unit", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//三级电子晶体
    ...
    public static final RegistryObject<Item> cutting_fluid_solution = ITEMS.register("cutting_fluid_solution", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级切削液
    public static final RegistryObject<Item> compound_cutting_fluid = ITEMS.register("compound_cutting_fluid", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级切削液
    public static final RegistryObject<Item> damaged_device = ITEMS.register("damaged_device", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级装置
    public static final RegistryObject<Item> device = ITEMS.register("device", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级装置
    public static final RegistryObject<Item> integrated_device = ITEMS.register("integrated_device", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//三级装置
    public static final RegistryObject<Item> optimized_device = ITEMS.register("optimized_device",()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//四级装置
    public static final RegistryObject<Item> coagulating_gel = ITEMS.register("coagulating_gel", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级凝胶
    public static final RegistryObject<Item> polymerized_gel = ITEMS.register("polymerized_gel", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级凝胶
    public static final RegistryObject<Item> grindstone = ITEMS.register("grindstone", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级研磨石
    public static final RegistryObject<Item> grindstone_pentahydrate = ITEMS.register("grindstone_pentahydrate", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级研磨石
    public static final RegistryObject<Item> incandescent_alloy = ITEMS.register("incandescent_alloy", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级炽合金
    public static final RegistryObject<Item> incandescent_alloy_block = ITEMS.register("incandescent_alloy_block", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级炽合金
    public static final RegistryObject<Item> loxic_kohl = ITEMS.register("loxic_kohl", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级醇
    public static final RegistryObject<Item> white_horse_kohl = ITEMS.register("white_horse_kohl",()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级醇
    public static final RegistryObject<Item> manganese_ore = ITEMS.register("manganese_ore", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级锰
    public static final RegistryObject<Item> manganese_trihydrate = ITEMS.register("manganese_trihydrate", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级锰
    public static final RegistryObject<Item> orirock = ITEMS.register("orirock", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级源岩
    public static final RegistryObject<Item> orirock_cube = ITEMS.register("orirock_cube", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级源岩
    public static final RegistryObject<Item> orirock_cluster = ITEMS.register("orirock_cluster", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//三级源岩
    public static final RegistryObject<Item> orirock_concentration = ITEMS.register("orirock_concentration", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//四级源岩
    public static final RegistryObject<Item> refined_solvent = ITEMS.register("refined_solvent", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级溶剂
    public static final RegistryObject<Item> semi_synthetic_solvent = ITEMS.register("semi_synthetic_solvent", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级溶剂
    public static final RegistryObject<Item> rma70_12 = ITEMS.register("rma70_12", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//一级海胆
    public static final RegistryObject<Item> rma70_24 = ITEMS.register("rma70_24", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//二级海胆
    public static final RegistryObject<Item> d32_steel = ITEMS.register("d32_steel", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//D32钢
    public static final RegistryObject<Item> bipolar_nanoflake = ITEMS.register("bipolar_nanoflake", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//纳米片
    public static final RegistryObject<Item> polymerization_preparation = ITEMS.register("polymerization_preparation", ()->new PreItem(new Item.Properties().tab(ModGroupRegistry.TERRA_WORLD_COMMON_MATERIAL)));//聚合剂
