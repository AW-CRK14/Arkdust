...
public class StructureProcessorListRegistry {
    ...
    public static void bootstrap(BootstapContext<StructureProcessorList> context) {
        ...
        register(context, SPIDER_WEB_75, ImmutableList.of(new TagRandomChangeProcessor(STRUCTURE$TAG_CHANGE_BLACKLIST,true,true,0.075F,()->BlockRegistry.dirty_concrete.get().defaultBlockState())));
