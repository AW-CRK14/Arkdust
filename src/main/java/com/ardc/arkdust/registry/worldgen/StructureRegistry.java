...
import static com.ardc.arkdust.worldgen.structure.ExtraStructureJigsawPool.TEST_BRIDGE;
...
public class StructureRegistry {
    ...
    public static void bootstrap(BootstapContext<Structure> context)  {
        ...
        context.register(CW$TEST_BRIDGE,new JigsawStructure(landSetting,poolHolderGetter.getOrThrow(TEST_BRIDGE),8, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
        context.register(STORE$MF$OASIS,new SMoonfallOasis(desertSetting));
        context.register(CW$GRAVELLY_WASTELAND_MINESHAFT,new GravellyWastelandMineshaft(wastelandSetting));
    }
...
//                gen.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION.ordinal(),()->
//    static {
//                        FeatureRegistry.ABS$LIST_NBT_FEATURE.get().place(new ListNBTFeatureConfig(Utils.MOD_ID+":biomefeature/faultline/ruin_",6,Arrays.asList(Blocks.GRAVEL,Blocks.COBBLESTONE, Blocks.STONE),-1,true,0.85F)).decorated(PlacementRegistry.RANDOM_OFFSET.get().configured(new RandomPosOffsetConfig(7))).chance(196));
//    }
